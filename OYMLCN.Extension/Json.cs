...
namespace OYMLCN.Extensions
{
    ...
    public static class JsonExtensions
    {
        ...
        public static string ToJsonString<T>(this T data, JsonSerializerOptions options = null) where T : class
        ...
        /// <returns></returns>
        public static T DeserializeJsonToObject<T>(this string str)
