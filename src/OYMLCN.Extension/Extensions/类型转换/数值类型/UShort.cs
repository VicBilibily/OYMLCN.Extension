...
namespace OYMLCN.Extensions
{
    ...
    {
        #region public static ushort ConvertToUShort(this string value)
        /// <summary>
        /// 将数字的指定字符串表示形式转换为等效的 16 位无符号整数
        /// </summary>
        /// <param name="value"> 包含要转换的数字的字符串 </param>
        /// <returns> 一个与 <paramref name="value"/> 中数字等效的 16 位无符号整数，如果 <paramref name="value"/> 为 null，则为 0（零） </returns>
        /// <exception cref="FormatException"> <paramref name="value"/> 不由一个可选符号后跟一系列数字 (0-9) 组成 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ushort.MinValue"/> 或大于 <see cref="ushort.MaxValue"/> 的数字 </exception>
        public static ushort ConvertToUShort(this string value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ConvertToUShort(this string value, int fromBase)
        /// <summary>
        ...
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ushort.MinValue"/> 或大于 <see cref="ushort.MaxValue"/> 的数字 </exception>
        public static ushort ConvertToUShort(this string value, int fromBase)
            => Convert.ToUInt16(value, fromBase);
        #endregion
        #region public static ushort ConvertToUShort(this string value, IFormatProvider provider)
        /// <summary>
        ...
        /// <exception cref="FormatException"> <paramref name="value"/> 不由一个可选符号后跟一系列数字 (0-9) 组成 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ushort.MinValue"/> 或大于 <see cref="ushort.MaxValue"/> 的数字 </exception>
        public static ushort ConvertToUShort(this string value, IFormatProvider provider)
            => Convert.ToUInt16(value, provider);
        #endregion
        #region public static ushort ConvertToUShort(this object value)
        /// <summary>
        ...
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ushort.MinValue"/> 或大于 <see cref="ushort.MaxValue"/> 的数字 </exception>
        public static ushort ConvertToUShort(this object value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ConvertToUShort(this object value, IFormatProvider provider)
        /// <summary>
        ...
        /// <exception cref="InvalidCastException"> <paramref name="value"/> 不实现 <see cref="IConvertible"/> 接口。 或 不支持该转换 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ushort.MinValue"/> 或大于 <see cref="ushort.MaxValue"/> 的数字 </exception>
        public static ushort ConvertToUShort(this object value, IFormatProvider provider)
            => Convert.ToUInt16(value, provider);
        #endregion

        #region public static ushort ToUShort(this bool value)
        /// <summary>
        ...
        public static ushort ToUShort(this bool value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this byte value)
        /// <summary>
        ...
        public static ushort ToUShort(this byte value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this char value)
        /// <summary>
        ...
        public static ushort ToUShort(this char value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this sbyte value)
        /// <summary>
        /// 将指定的 8 位带符号整数的值转换为等效的 16 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 8 位带符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 16 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 小于零 </exception>
        public static ushort ToUShort(this sbyte value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this short value)
        /// <summary>
        ...
        public static ushort ToUShort(this short value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this int value)
        /// <summary>
        /// 将指定的 32 位有符号整数的值转换为等效的 16 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 32 位带符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 16 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 小于零或大于 <see cref="ushort.MaxValue"/> </exception>
        public static ushort ToUShort(this int value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this long value)
        /// <summary>
        ...
        public static ushort ToUShort(this long value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this uint value)
        /// <summary>
        /// 将指定的 32 位无符号整数的值转换为等效的 16 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 16 位无符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 16 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 大于 <see cref="ushort.MaxValue"/> </exception>
        public static ushort ToUShort(this uint value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this ulong value)
        /// <summary>
        ...
        public static ushort ToUShort(this ulong value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this float value)
        /// <summary>
        ...
        public static ushort ToUShort(this float value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this double value)
        /// <summary>
        ...
        public static ushort ToUShort(this double value)
            => Convert.ToUInt16(value);
        #endregion
        #region public static ushort ToUShort(this decimal value)
        /// <summary>
