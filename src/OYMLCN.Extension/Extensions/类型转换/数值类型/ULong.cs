...
namespace OYMLCN.Extensions
{
    ...
    {
        #region public static ulong ConvertToULong(this string value)
        /// <summary>
        ...
        public static ulong ConvertToULong(this string value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ConvertToULong(this string value, int fromBase)
        /// <summary>
        ...
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="ulong.MinValue"/> 或大于 <see cref="ulong.MaxValue"/> 的数字 </exception>
        public static ulong ConvertToULong(this string value, int fromBase)
            => Convert.ToUInt32(value, fromBase);
        #endregion
        #region public static ulong ConvertToULong(this string value, IFormatProvider provider)
        /// <summary>
        ...
        public static ulong ToULong(this bool value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this byte value)
        /// <summary>
        ...
        public static ulong ToULong(this byte value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this char value)
        /// <summary>
        ...
        public static ulong ToULong(this char value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this sbyte value)
        /// <summary>
        /// 将指定的 8 位带符号整数的值转换为等效的 64 位无符号整数
        /// </summary>
        ...
        public static ulong ToULong(this sbyte value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this short value)
        /// <summary>
        ...
        public static ulong ToULong(this short value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this int value)
        /// <summary>
        ...
        public static ulong ToULong(this int value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this long value)
        /// <summary>
        /// 将指定的 64 位有符号整数的值转换为等效的 64 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 64 位带符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 64 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 小于零或大于 <see cref="ulong.MaxValue"/> </exception>
        public static ulong ToULong(this long value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this ushort value)
        /// <summary>
        ...
        public static ulong ToULong(this ushort value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this uint value)
        /// <summary>
        ...
        public static ulong ToULong(this uint value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this float value)
        /// <summary>
        ...
        public static ulong ToULong(this float value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this double value)
        /// <summary>
        ...
        public static ulong ToULong(this double value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static ulong ToULong(this decimal value)
        /// <summary>
