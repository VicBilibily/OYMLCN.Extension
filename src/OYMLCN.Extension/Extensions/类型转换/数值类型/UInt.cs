...
namespace OYMLCN.Extensions
{
    ...
    {
        #region public static uint ConvertToUInt(this string value)
        /// <summary>
        /// 将数字的指定字符串表示形式转换为等效的 32 位无符号整数
        /// </summary>
        /// <param name="value"> 包含要转换的数字的字符串 </param>
        /// <returns> 一个与 <paramref name="value"/> 中数字等效的 32 位无符号整数，如果 <paramref name="value"/> 为 null，则为 0（零） </returns>
        /// <exception cref="FormatException"> <paramref name="value"/> 不由一个可选符号后跟一系列数字 (0-9) 组成 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="uint.MinValue"/> 或大于 <see cref="uint.MaxValue"/> 的数字 </exception>
        public static uint ConvertToUInt(this string value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ConvertToUInt(this string value, int fromBase)
        /// <summary>
        ...
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="uint.MinValue"/> 或大于 <see cref="uint.MaxValue"/> 的数字 </exception>
        public static uint ConvertToUInt(this string value, int fromBase)
            => Convert.ToUInt32(value, fromBase);
        #endregion
        #region public static uint ConvertToUInt(this string value, IFormatProvider provider)
        /// <summary>
        ...
        #endregion
        #region public static uint ConvertToUInt(this object value)
        /// <summary>
        ...
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="uint.MinValue"/> 或大于 <see cref="uint.MaxValue"/> 的数字 </exception>
        public static uint ConvertToUInt(this object value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ConvertToUInt(this object value, IFormatProvider provider)
        /// <summary>
        ...
        /// <exception cref="InvalidCastException"> <paramref name="value"/> 不实现 <see cref="IConvertible"/> 接口。 或 不支持该转换 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="uint.MinValue"/> 或大于 <see cref="uint.MaxValue"/> 的数字 </exception>
        public static uint ConvertToUInt(this object value, IFormatProvider provider)
            => Convert.ToUInt32(value, provider);
        #endregion

        #region public static uint ToUInt(this bool value)
        /// <summary>
        ...
        public static uint ToUInt(this bool value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this byte value)
        /// <summary>
        ...
        public static uint ToUInt(this byte value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this char value)
        /// <summary>
        ...
        public static uint ToUInt(this char value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this sbyte value)
        /// <summary>
        /// 将指定的 8 位带符号整数的值转换为等效的 32 位无符号整数
        /// </summary>
        ...
        public static uint ToUInt(this sbyte value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this short value)
        /// <summary>
        ...
        public static uint ToUInt(this short value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this int value)
        /// <summary>
        ...
        public static uint ToUInt(this int value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this long value)
        /// <summary>
        /// 将指定的 64 位有符号整数的值转换为等效的 32 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 64 位带符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 32 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 小于零或大于 <see cref="uint.MaxValue"/> </exception>
        public static uint ToUInt(this long value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this ushort value)
        /// <summary>
        ...
        public static uint ToUInt(this ushort value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this ulong value)
        /// <summary>
        /// 将指定的 64 位无符号整数的值转换为等效的 32 位无符号整数
        /// </summary>
        /// <param name="value"> 要转换的 64 位无符号整数 </param>
        /// <returns> 一个与 <paramref name="value"/> 等效的 32 位无符号整数 </returns>
        /// <exception cref="OverflowException"> <paramref name="value"/> 大于 <see cref="uint.MaxValue"/> </exception>
        public static uint ToUInt(this ulong value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this float value)
        /// <summary>
        ...
        public static uint ToUInt(this float value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this double value)
        /// <summary>
        ...
        public static uint ToUInt(this double value)
            => Convert.ToUInt32(value);
        #endregion
        #region public static uint ToUInt(this decimal value)
        /// <summary>
