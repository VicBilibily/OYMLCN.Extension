...
namespace OYMLCN.Extensions
{
    ...
    public static partial class ConvertExtension
    {
        ...
        #endregion
        #region public static long ConvertToLong(this object value)
        /// <summary>
        ...
        public static long ConvertToLong(this object value)
            => Convert.ToInt64(value);
        #endregion
        #region public static long ConvertToLong(this object value, IFormatProvider provider)
        /// <summary>
        ...
        /// <exception cref="InvalidCastException"> <paramref name="value"/> 不实现 <see cref="IConvertible"/> 接口。 或 不支持该转换 </exception>
        /// <exception cref="OverflowException"> <paramref name="value"/> 表示一个小于 <see cref="long.MinValue"/> 或大于 <see cref="long.MaxValue"/> 的数字 </exception>
        public static long ConvertToLong(this object value, IFormatProvider provider)
            => Convert.ToInt64(value, provider);
        #endregion
