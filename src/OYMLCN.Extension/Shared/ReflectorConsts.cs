...
namespace OYMLCN
{
    public static class ReflectorConsts
    {
        ...
        public static readonly MethodInfo StringContains = typeof(string).GetMethod("Contains", new[] { typeof(string) });
        ...
        public static readonly MethodInfo ConvertToDateTimeMethod = ConvertType.GetMethod("ToDateTime", new[] { ObjectType });
        public static readonly MethodInfo ConvertToStringMethod = ConvertType.GetMethod("ToString", new[] { ObjectType });
        public static readonly MethodInfo ConvertToInt32Method = ConvertType.GetMethod("ToInt32", new[] { ObjectType });
        public static readonly MethodInfo ConvertToBoolMethod = ConvertType.GetMethod("ToBool", new[] { ObjectType });
        public static readonly MethodInfo AddDaysMethod = DateTimeType.GetMethod("AddDays", new[] { DoubleType });

        public static readonly MethodInfo AddOfList = ListType.GetMethods().FirstOrDefault(x => x.Name == "Add" && x.GetParameters().Length == 1);

        public static readonly MethodInfo GetStringOfIDataReader = IDataRecordType.GetMethod("GetString", new[] { Int32Type });
        public static readonly MethodInfo GetInt16OfIDataReader = IDataRecordType.GetMethod("GetInt16", new[] { Int32Type });
        public static readonly MethodInfo GetInt32OfIDataReader = IDataRecordType.GetMethod("GetInt32", new[] { Int32Type });
        public static readonly MethodInfo GetInt64OfIDataReader = IDataRecordType.GetMethod("GetInt64", new[] { Int32Type });
        public static readonly MethodInfo IsDBNullfIDataReader = IDataRecordType.GetMethod("IsDBNull", new[] { Int32Type });
        public static readonly MethodInfo GetBooleanOfIDataReader = IDataRecordType.GetMethod("GetBoolean", new[] { Int32Type });
        public static readonly MethodInfo GetDoubleOfIDataReader = IDataRecordType.GetMethod("GetDouble", new[] { Int32Type });
        public static readonly MethodInfo GetFloatOfIDataReader = IDataRecordType.GetMethod("GetFloat", new[] { Int32Type });
        public static readonly MethodInfo GetByteOfIDataReader = IDataRecordType.GetMethod("GetByte", new[] { Int32Type });
        public static readonly MethodInfo GetDecimalOfIDataReader = IDataRecordType.GetMethod("GetDecimal", new[] { Int32Type });
        public static readonly MethodInfo GetDateTimeOfIDataReader = IDataRecordType.GetMethod("GetDateTime", new[] { Int32Type });
        public static readonly MethodInfo GetOrdinalOfIDataReader = IDataRecordType.GetMethod("GetOrdinal", new[] { StringType });
