...
namespace OYMLCN.T3P.Encrypt
{
    ...
    public class EncryptProvider
    {
        ...
        */
        ...
        /// <param name="base64">convert to base64 result</param>
        /// <returns></returns>
        public static string HMACMD5(string srcString, string key, bool base64 = false)
        {
            Check.Argument.IsNotEmpty(srcString, nameof(srcString));
            Check.Argument.IsNotEmpty(key, nameof(key));
            ...
            using (HMACMD5 md5 = new HMACMD5(secrectKey))
            {
                ...
                if (base64) return Convert.ToBase64String(bytes_md5_out);
        ...
        /// <param name="base64">convert to base64 result</param>
        /// <returns></returns>
        public static string HMACSHA1(string srcString, string key, bool base64 = false)
        {
            Check.Argument.IsNotEmpty(srcString, nameof(srcString));
            Check.Argument.IsNotEmpty(key, nameof(key));
            ...
            using (HMACSHA1 hmac = new HMACSHA1(secrectKey))
            {
                ...
                if (base64) return Convert.ToBase64String(bytes_hamc_out);
        ...
        /// <param name="base64">convert to base64 result</param>
        /// <returns></returns>
        public static string HMACSHA256(string srcString, string key, bool base64 = false)
        {
            Check.Argument.IsNotEmpty(srcString, nameof(srcString));
            Check.Argument.IsNotEmpty(key, nameof(key));
        ...
        /// <param name="base64">convert to base64 result</param>
        /// <returns></returns>
        public static string HMACSHA384(string srcString, string key, bool base64 = false)
        {
            Check.Argument.IsNotEmpty(srcString, nameof(srcString));
            Check.Argument.IsNotEmpty(key, nameof(key));
        ...
        /// <param name="base64">convert to base64 result</param>
        /// <returns></returns>
        public static string HMACSHA512(string srcString, string key, bool base64 = false)
        {
            Check.Argument.IsNotEmpty(srcString, nameof(srcString));
            Check.Argument.IsNotEmpty(key, nameof(key));
